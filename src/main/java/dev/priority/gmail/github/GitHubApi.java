...
public class GitHubApi {
    ...
    public String getUserData(String owner, String repo, int number) {
        RestTemplate restTemplate = new RestTemplate();
        String url = "https://api.github.com/repos/" + owner + "/" + repo + "/pulls/" + number + "?access_token=9c3d0d236afd211a7955d7363c164136a84af76e";
